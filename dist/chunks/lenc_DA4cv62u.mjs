...
const data = {title:"LC E&C Company",image:
						new Proxy({"src":"/_astro/lenc.DXSBKOVM.png","width":906,"height":514,"format":"png","fsPath":"/var/www/Develop/astro/mindevs-landing/src/content/showcase/_images/lenc.png"}, {
